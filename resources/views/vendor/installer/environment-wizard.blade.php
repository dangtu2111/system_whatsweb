    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('facebook_secret') ? ' has-error ' : '' }}">
                    <label for="facebook_secret">
                        Facebook Secret
                    </label>
                    <input type="text" name="facebook_secret" id="facebook_secret" placeholder="Facebook Secret" />
                    @if ($errors->has('facebook_secret'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('facebook_secret') }}
                        </span>
                    @endif
                </div>
                ...
                <div class="form-group {{ $errors->has('facebook_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" readonly="" name="facebook_url" id="facebook_url" placeholder="Facebook Callback URL" value="{{ url('auth/facebook/callback') }}" />
                    <div class="form-text">
                        Add this to the "Valid OAuth Redirect URIs" field on your Facebook App.
                    </div>
                ...
                <div class="form-group {{ $errors->has('google_id') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="google_id" id="google_id" placeholder="Google ID" />
                ...
                <div class="form-group {{ $errors->has('google_secret') ? ' has-error ' : '' }}">
                    <label for="google_secret">
                        Google Secret
                    </label>
                    <input type="text" name="google_secret" id="google_secret" placeholder="Google Secret" />
                    @if ($errors->has('google_secret'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('google_secret') }}
                        </span>
                    @endif
                </div>
                ...
                <div class="form-group {{ $errors->has('google_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="google_url" id="google_url" readonly="" placeholder="Google Callback URL" value="{{ url('auth/google/callback') }}" />
                    <div class="form-text">
                        Add this as a callback URL on your Google project.
                    </div>
