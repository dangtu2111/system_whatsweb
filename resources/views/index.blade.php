              ...
              <div class="card gradient-bottom">
                ...
                <div class="card-body" id="top-5-scroll">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{asset('')}}dist/img/products/product-3-50.png" alt="product">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{asset('')}}dist/img/products/product-4-50.png" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{asset('')}}dist/img/products/product-1-50.png" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="{{asset('')}}dist/img/products/product-5-50.png" alt="product">
                      <div class="media-body">
                  ...
                  <div class="owl-carousel owl-theme" id="products-carousel">
                    <div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="{{asset('')}}dist/img/products/product-4-50.png" class="img-fluid">
                        </div>
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="{{asset('')}}dist/img/products/product-3-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="{{asset('')}}dist/img/products/product-1-50.png" class="img-fluid">
                        </div>
                        <div class="product-details">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="{{asset('')}}dist/modules/flag-icon-css/flags/4x3/id.svg" alt="image" width="40">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="{{asset('')}}dist/modules/flag-icon-css/flags/4x3/my.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="{{asset('')}}dist/modules/flag-icon-css/flags/4x3/us.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                    ...
                    <div class="col-sm-6 mt-sm-0 mt-4">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="{{asset('')}}dist/modules/flag-icon-css/flags/4x3/ps.svg" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="{{asset('')}}dist/modules/flag-icon-css/flags/4x3/de.svg" alt="image" width="40">
                          <div class="media-body ml-3">
  ...
  <script src="{{asset('')}}dist/js/page/dashboard-ecommerce.js"></script>
