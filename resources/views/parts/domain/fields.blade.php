						<div class="row" id="create-wa-link">
							<div class="{{(request()->type ?? @$the_type ?? $link->type) == 'WHATSAPP' ? 'col-md-6 col-lg-7 mt-0 mt-lg-4' : 'col-lg-10 mt-0 mt-lg-4'}}">
								@if(isset($link))
								<form action="{{ route_type('domain.update', [$id]) }}" method="post" id="link-form">
									{!! method_field('PUT') !!}
									@else
									<form action="{{ route_type('domain.store') }}" method="post" id="link-form">
										@endif
										@if(isset($show_type))
										...
										<div class="form-group row">
											...
											<div class="col-lg-8">
												<input type="text" name="url" class="form-control" id="url" value="{!! isset($link) ? optional($link)->slug : '' !!}">
												<div class="form-text">
										...
										<div class="form-group row">
											...
											<div class="col-lg-8">
												<input type="text" name="name_phone" class="form-control" id="url" value="{!! isset($link) ? optional($link)->name : '' !!}">
												<div class="form-text">
											...
											<div class="conversation">
												<div class="conversation-container">
													<div class="message sent">
														...
														<span class="metadata">
															<span class="time">{{date('h:i A')}}</span><span class="tick"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" id="msg-dblcheck-ack" x="2063" y="2076">
