					...
					<div class="tab-content mt-2">
						<div class="tab-pane active" id="result-raw">
							...
							<div class="input-group">
								<textarea type="text" style=" height: 200px !important;!i;!;" class="form-control" name="raw_url" id="raw_url" readonly="" onfocus="this.setSelectionRange(0, this.value.length)"></textarea>
